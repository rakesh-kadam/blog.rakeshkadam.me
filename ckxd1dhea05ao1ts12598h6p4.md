...
- Group of services which include: blob storage,
queue storage,
table storage, and
file storage
- Used to store: files,
...
- Three storage tiers: Hot – frequently accessed data
...
- Storage for semi-structured data (NoSQL): No need for foreign joins, foreign keys, relationships or strict schema
